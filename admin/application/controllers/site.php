...
//		$this->load->view( 'template', $data );	
	...
	function createpropertysubmit()
	{
		...
		else
		{
			...
			if($this->property_model->createproperty($name,$area,$description,$lat,$long,$price,$builder,$propertytype,$status)==0)
	...
	function editpropertysubmit()
	{
		...
		else
		{
			...
			$builder=$this->input->post('builder');
			$propertytype=$this->input->post('propertytype');
			if($this->property_model->editproperty($id,$name,$area,$description,$lat,$long,$price,$builder,$propertytype,$status)==0)
	...
	function uploadpropertyimagesubmit()
	 {
		...
		else
		{
			$id=$this->input->get('id');
			$uploaddata  = $this->upload->data();
			$this->property_model->addimage($id,$uploaddata);
